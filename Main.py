...
background = (229, 229, 203)

# color of the lines on the board

line_color = (26, 18, 11)

# setting up a 3 * 3 board
...
# this method is used to build the display

screen = pygame.display.set_mode((width, height + 100), 0, 32)

# setting up a nametag for the game window

pygame.display.set_caption("Hariharan's Tic Tac Toe")

# loading the images as python object

initiating_window = pygame.image.load("./Assets/modified_cover.png")

x_img = pygame.image.load("./Assets/X_modified.png")

y_img = pygame.image.load("./Assets/o_modified.png")
...
def draw_status():
	...
	if winner is None:
		...
		message = playerChar.upper() + "'s Turn"
	...
	# copy the rendered message onto the board and creating a small block at the bottom of the main display

	screen.fill((26, 18, 11), (0, 400, 500, 100))
...
def user_click():
	...
	# drawing the images at the desired positions
...
def reset_game():
	...
	global board, winner, playerChar, draw
	time.sleep(3)
	playerChar = 'x'
	draw = False
